          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <motion.div
                ...
                className="bg-gray-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:shadow-[#3CAAFF]/10 transition-all cursor-pointer"
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#3CAAFF] flex items-center">
                    Read more
