...
const Footer = () => {
  return (
    <footer className="bg-black text-[#ABABAB] pt-16 pb-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start pb-12 border-b border-[#111111]">
          ...
          <div className="max-w-md">
            ...
            <p className="text-[#777777]">
              Equinology blends timeless equestrian tradition with innovative
              design to create extraordinary experiences for horse enthusiasts,
              breeders, and equestrian facilities worldwide.
            </p>
          </div>
