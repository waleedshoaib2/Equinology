          ...
          >
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-3 bg-[#111111]/50 border border-[#222222]/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3CAAFF]/50 text-[#F5F5F7]"
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-[#3CAAFF] to-[#00E0FF] text-[#0A0A0A] py-3 px-6 rounded-lg font-medium flex items-center justify-center hover:shadow-lg hover:shadow-[#3CAAFF]/25 transition-all duration-300"
              >
                Send Message
